    ...
    <div className="fixed inset-0 bg-gray-100 overflow-auto">
      ...
      <div className="min-h-screen flex items-center justify-center p-4">
        <div className="bg-white rounded-lg p-6 shadow-md w-full max-w-md">
          <h1 className="text-3xl font-bold mb-6 text-center">Accessibility Settings</h1>
          <div className="w-full">
            <label htmlFor="color-mode" className="block text-lg font-medium text-gray-700 mb-2">
